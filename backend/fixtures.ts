          ...
          [
            {
              ...
              icon: 'mapMarkers/hiking-map-marker.svg',
              title: 'tour point',
              strokeColor: '#9b33fc',
            },
            {
              coordinates: '42.801027, 74.649165',
              icon: 'mapMarkers/bus-map-marker.svg',
              title: 'tour point',
              strokeColor: '#9b33fc',
            },
            {
              coordinates: '42.800938, 74.651593',
              icon: 'mapMarkers/camera-map-marker.svg',
              title: 'tour point',
              strokeColor: '#9b33fc',
            },
            {
              coordinates: '42.801066, 74.653824',
              icon: 'mapMarkers/hotel-map-marker.svg',
              title: 'tour point',
              strokeColor: '#9b33fc',
            },
            {
              coordinates: '42.797932, 74.670694',
              icon: 'mapMarkers/park-map-marker.svg',
              title: 'tour point',
              strokeColor: '#9b33fc',
            },
            {
              coordinates: '42.795424, 74.67018',
              icon: 'mapMarkers/default-map-marker.svg',
              title: 'tour point',
              strokeColor: '#9b33fc',
            },
            {

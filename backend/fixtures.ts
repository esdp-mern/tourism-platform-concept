...
const run = async () => {
  ...
  const [Burana, AlaKul, Canyon, IssykKul, SaryChelek] = await Tour.create(
    ...
    },
    {
      ...
      plan: [
        ...
        {
          title: 'From Altyn Arashan to AkSuu - Karakol Town - back to Bishkek',
          planDescription:
    ...
    },
    {
      ...
      plan: [
        ...
        },
        {
          ...
          planDescription: 'Transfer to the airport (30 km). End of the tour.',
        },
      ],
  ...
  // const [review1, review2, review3, review5, review6] =
  await Review.create(
    {
      user: user._id,
      tour: Burana._id,

    ...
    await Tour.create(
      {
        ...
        description: {
          ...
          ru: 'Здесь должно быть описания тура',
          kg: 'Here must be tour description translated into kyrgyz language',
        },
        ...
        plan: [
          {
            ...
            planDescription: {
              ...
              ru: '*Описание плана на русском языке*',
              kg: '*Описание плана на кыргызском языке*',
            },
          },
        ],
        ...
        plan: [
          ...
          },
          {
            title: {
              ...
              ru: '*Название плана на русском*',
              kg: '*Название плана на кыргызском*',
            },
            planDescription: {
...
//           ru: '*Название тура на русском языке*',
//           kg: '*Название тура на кыргызском языке*',
//         },
//         mainImage: 'fixtures/burana.jpeg',
//         description: {
//           en: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta hic inventore minus porro quisquam voluptas.',
//           ru: 'Здесь должно быть описания тура',
//           kg: 'Here must be tour description translated into kyrgyz language',
//         },
//         category: ['history', 'exotic'],
